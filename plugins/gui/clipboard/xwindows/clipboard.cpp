...
//   However, in the implementation displayed here it only executes copy and uses the data stored as the return value for paste text. This allows SelectionNotify to be caught 
//      and processed within one function instead of requiring a separate function to return the data.
