...
CharactersTableVO* CharacterTable::parseSingleResultSet(ResultSet* rs, size_t row)
{
  ...
  vo->hair_b = (unsigned char) atoi(rs->GetData(row,7).c_str());
  vo->skin_r = (unsigned char) atoi(rs->GetData(row,8).c_str());
  vo->skin_g = (unsigned char) atoi(rs->GetData(row,9).c_str());
  vo->skin_b = (unsigned char) atoi(rs->GetData(row,10).c_str());
  vo->decal_r = (unsigned char) atoi(rs->GetData(row,11).c_str());
  vo->decal_g = (unsigned char) atoi(rs->GetData(row,12).c_str());
  vo->decal_b = (unsigned char) atoi(rs->GetData(row,13).c_str());
