...
public:
  ...
  void createTable();
  void insert(int id, ptString name, int user_id, ptString mesh, int race_id, unsigned char haircolour[3], unsigned char skincolour[3], unsigned char decalcolour[3], float pos[3], ptString sector);
  int getMaxId();
  void dropTable();
  void remove(int id);
