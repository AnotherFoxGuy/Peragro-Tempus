...
public:
  /// The id of the zone.
  int id;
  /// The coords defining the area of the zone.
  PtVector2 coords;
   ...
   * @param coords The coords defining the area of the zone.
   * @param type Which type of zone it is.
   */
  ZonesTableVO(int id, PtVector2 coords, int type)
  : id(id), coords(coords), type(type)
  {
  }
};
