...
public:
  ...
  char getType() { return MESSAGES::PLAYER; }

  void handle(GenericMessage* msg)
  {
    char type = msg->getMsgType();
    if (type != MESSAGES::PLAYER) assert("wrong message type");
    char id = msg->getMsgId();

    if (id == PLAYER::INVENTORYMOVEITEMREQUEST) handleInventoryMoveItemRequest(msg);
  }

  void handleInventoryMoveItemRequest(GenericMessage* msg);
};

#endif // _PLAYERHANDLER_H_
