...
#ifndef SPECIES_VULNERABILITIES_H
#define SPECIES_VULNERABILITIES_H
...
class SpeciesVulnerabilities
{
private:
  Character* entity;
  boost::shared_ptr<Vulnerabilities> vulnerabilities;

  float GetVulnerabilityValue(size_t speciesId, float age, const std::string& name);

public:
  SpeciesVulnerabilities(Character* entity);
...
#endif // SPECIES_VULNERABILITIES_H
