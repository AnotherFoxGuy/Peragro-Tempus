...
namespace PT
{
  namespace Input
  {
    ControlCombo::Key ControlCombo::SpecialKeys[] =
    {
      ...
      { CSKEY_PAD9        , "Pad9"       },
      { CSKEY_PAD0        , "Pad0"       },
      { CSKEY_PADDECIMAL  , "PadDecimal" },
      { CSKEY_PADDIV      , "PadDiv"     },
      { CSKEY_PADMULT     , "PadMult"    },
      { CSKEY_PADMINUS    , "PadMinus"   },
      { CSKEY_PADPLUS     , "PadPlus"    },
      { CSKEY_PADENTER    , "Enter"      },
      { CSKEY_DASH        , "Dash"       },
      { csmbLeft          , "LMB"        },
      { csmbRight         , "RMB"        },
      { csmbMiddle        , "MMB"        },
    ...
    std::string ControlCombo::ConfigString() const
    {
