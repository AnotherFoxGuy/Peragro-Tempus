...
namespace PT
{
  namespace Entity
  {
    ...
    Equipment::Equipment(::Client::Entity::Entity* entity) : entity(entity)
    {
    }
    ...
    void Equipment::Equip(unsigned int slotId, unsigned int itemId, const std::string& meshname, const std::string& meshfile)
    {
